...
type
  TfrmCom_NewsPaper_Detail = class(TForm)
...
var
  frmCom_NewsPaper_Detail: TfrmCom_NewsPaper_Detail;
implementation
...
procedure TfrmCom_NewsPaper_Detail.btnBdInfoClick(Sender: TObject);
begin
  g_Sel_ActionKind := 1;
  g_Sel_Title      := '대상빌딩정보';
...
procedure TfrmCom_NewsPaper_Detail.btnCloseClick(Sender: TObject);
begin
  Close;
end;

procedure TfrmCom_NewsPaper_Detail.btnDeleteClick(Sender: TObject);
begin
...
procedure TfrmCom_NewsPaper_Detail.FormShow(Sender: TObject);
begin
...
procedure TfrmCom_NewsPaper_Detail.btnSelect_BdClick(Sender: TObject);
begin
  g_Sel_Title    := '빌딩선택';
...
procedure TfrmCom_NewsPaper_Detail.btnUrlClick(Sender: TObject);
begin
  if Trim(edtUrl.Text) <> '' then  p_Open_Url_New(edtUrl.Text);
end;

procedure TfrmCom_NewsPaper_Detail.btnSaveClick(Sender: TObject);
begin
...
procedure TfrmCom_NewsPaper_Detail.edtBdNameChange(Sender: TObject);
begin
  if Trim(edtBdName.Text)='' then begin
     edtBdCode.Text    := '';
     edtBdName_DB.Text := '';
...
procedure TfrmCom_NewsPaper_Detail.edtBdNameKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char; Shift: TShiftState);
begin
  edtBdNameChange(Sender);
end;

procedure TfrmCom_NewsPaper_Detail.edtUrlKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char; Shift: TShiftState);
begin
  edtUrlChange(Sender);
end;


procedure TfrmCom_NewsPaper_Detail.edtUrlChange(Sender: TObject);
begin
  btnUrl.Visible := not(Trim(edtUrl.Text)='');
end;


procedure TfrmCom_NewsPaper_Detail.FormActivate(Sender: TObject);
begin
...
procedure TfrmCom_NewsPaper_Detail.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TfrmCom_NewsPaper_Detail.MenuButtonClick(Sender: TObject);
begin
  Close;
end;

initialization
   RegisterClasses([TfrmCom_NewsPaper_Detail]);

finalization
   UnRegisterClasses([TfrmCom_NewsPaper_Detail]);
