...
type
  TfrmCom_MasterDetail_Etc = class(TForm)
...
var
  frmCom_MasterDetail_Etc: TfrmCom_MasterDetail_Etc;
...
procedure TfrmCom_MasterDetail_Etc.FormShow(Sender: TObject);
begin
...
procedure TfrmCom_MasterDetail_Etc.p_SetComboBox(Sender: TObject);
var i:integer;
begin
...
procedure TfrmCom_MasterDetail_Etc.TabControl_DetailChange(Sender: TObject);
begin
  with frmCom_DataModule.ClientDataSet_Proc do begin
    if g_Sel_Action_Name = 'Com_DB_Office' then begin
      p_CreatePrams;
...
procedure TfrmCom_MasterDetail_Etc.ComboBox_SelClosePopup(Sender: TObject);
begin
  btnQueryClick(Sender);
end;
...
procedure TfrmCom_MasterDetail_Etc.btnQueryClick(Sender: TObject);
begin
...
procedure TfrmCom_MasterDetail_Etc.ListView_ListItemClick(const Sender: TObject; const AItem: TListViewItem);
begin
...
procedure TfrmCom_MasterDetail_Etc.p_Detail_Memo(const Sender: TObject; const AItem: TListViewItem);
begin
...
procedure TfrmCom_MasterDetail_Etc.p_Detail_ListView(const Sender: TObject; const AItem: TListViewItem);
begin
...
procedure TfrmCom_MasterDetail_Etc.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := TCloseAction.caFree;
end;


procedure TfrmCom_MasterDetail_Etc.FormResize(Sender: TObject);
begin
...
procedure TfrmCom_MasterDetail_Etc.MenuButtonClick(Sender: TObject);
begin
  Close;
end;
